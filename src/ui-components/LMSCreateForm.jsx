...
export default function LMSCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setPoint_1(initialValues.Point_1);
    setPoint_2(initialValues.Point_2);
    setPoint_3(initialValues.Point_3);
    setPoint_4(initialValues.Point_4);
    setPoint_5(initialValues.Point_5);
    setPoint_6(initialValues.Point_6);
    setPoint_7(initialValues.Point_7);
    setPoint_8(initialValues.Point_8);
    setPoint_9(initialValues.Point_9);
    setPoint_10(initialValues.Point_10);
    setPoint_11(initialValues.Point_11);
    setPoint_12(initialValues.Point_12);
    setPoint_13(initialValues.Point_13);
    setErrors({});
  };
  const validations = {
    Date: [],
